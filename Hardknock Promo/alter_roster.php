...
mysql_query("UPDATE $table set Rosterid='$rosterid',
Name='$name', 
Height='$height',
Weight='$weight',
Style='$style',
...
Girl='$girl'
WHERE Rosterid = '$rosterid'") or die(mysql_error());
...
$filename="images/roster/".$rosterid.".jpg";
$destination="images/roster/thumbs/".$rosterid.".jpg";
