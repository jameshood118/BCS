...
<?php 
$previousfile=$_POST['previousfile'];
$Idnum=$_POST['selected_banner'];
$link=$_POST['link'];
...
$postpicname="$Idnum$picturename";


mysql_query("UPDATE $table SET Idnum='$Idnum', 
Link='$postlink', 
Filename='$postpicname'
...
ftp_delete($conn_id, "../images/banners/".$previousfile."");
ftp_delete($conn_id, "../images/banners/thumbs/".$previousfile."");
