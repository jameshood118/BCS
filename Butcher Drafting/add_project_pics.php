...
$destination_file="images/projects/".$newname."/".$addfiles."";
...
<form name="return" method="post" action="make_thumb_addfiles.php">
<input type="hidden" name="filename" value="<?php echo $addfiles?>">
