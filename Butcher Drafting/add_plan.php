...
?>
  <FORM ENCTYPE="multipart/form-data" ACTION="insert_plan.php" METHOD=POST>
    <table width="935" border="0" cellspacing="0" cellpadding="5">
      <tr> 
        <td width="230"><div align="right">Product_name: </div></td>
        <td width="230"><input name="product_name" type="text" id="product_name"></td>
      ...
      <tr> 
        ...
        <td><textarea name="description" cols="30" rows="5" wrap="virtual"></textarea></td>
...
print ('<input type="hidden" value="'.$loginpass.'" name="password">');
        ...
        <td width="230"> <div align="right"> 
            <input type="submit" name="Submit" value="Submit Plan">
          </div></td>
      </tr>
    </table>
  </form>
