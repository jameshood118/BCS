      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
		  ...
		  ?>
			...
			<input name="selected_contact" type="hidden" id="selected_contact" value="<?php echo $selected_contact?>">
                <?php 
					  print ('<input type="hidden" name="login" value="'.$login.'">');
print ('<input type="hidden" name="password" value="'.$password.'">');
					  ?>
                <input type="submit" name="Submit2" value="Delete This Contact">
              </form>
			</div>
		  <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="alter_contact.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  <tr> 
                    <td colspan="2"><div align="center"> 
                        <p class="title" style="text-align:center">Edit Contact</p>
                      </div></td>
                  </tr>
                  <tr> 
...
$rank = $row['Rank'];
					...
					?>
                        Editing Contact: <?php echo $name?></div></td>
                    <td width="320"> <input name="selected_contact" type="hidden" id="banner_id" value="<?php echo $selected_contact?>"> 
                    </td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    ...
                    <td width="320"><input name="phone" type="text" id="phone" value="<?php echo $phone?>"></td>
                  </tr>
                  <tr> 
