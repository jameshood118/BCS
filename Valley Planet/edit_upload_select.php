      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="upload_pages.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  <tr> 
                    <td colspan="2"><div align="center"> 
                        <p class="title" style="text-align:center">Edit Issue 
                          To Upload Pages For</p>
                      </div></td>
                  </tr>
                  <tr> 
                    <td width="320"> <div align="right">Issue To Edit:</div></td>
                    <td width="320"><select name="issue_number">
                        <?php 
...
print ('<option value="'.$issueid.'">'.$displayname.'</option>');
...
print ('<input type="hidden" name="password" value="'.$password.'">');
					  ?>
                        <input type="submit" name="Submit" value="Edit Selected Issue">
                      </div></td>
                  </tr>
                </table>
              </form>
