      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
              ...
              <FORM ENCTYPE="multipart/form-data" ACTION="edit_business.php" METHOD=POST>
...
print ('<center>Select Business to Edit: </center><BR></td></tr><tr><td><select name="selected_business">');
