...
mysql_query("DELETE FROM $table WHERE issueid = '$issueid'") or die(mysql_error());
...
$dir = 'images/issue_pages/'.$issueid.'';
$handle=opendir($dir);
...
$pdffile = 'images/issue_pdfs/'.$issueid.'.pdf';

ftp_delete ($conn_id, $pdffile);


				  ///end upload cover image script
				  ftp_close($conn_id);
				  ?>
                      <p class="title" style="text-align:center">Issue <?php echo $new_issue?> 
                        Deleted.</p>
                    </div></td>
                </tr>
                <tr> 
