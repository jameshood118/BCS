...
<html>
<head>
<title>Valley Planet - Edit Business Category</title>
      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
              ...
              <FORM ENCTYPE="multipart/form-data" ACTION="edit_business_category.php" METHOD=POST>
...
print ('<center>Select Business Category to Edit: </center><BR></td></tr><tr><td><select name="selected_business_category">');
