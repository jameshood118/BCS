...
<html>
<head>
<title>Valley Planet - Edit Staff/Writer Select</title>
...
<div id="invis"> 
  ...
  <div id="content"> 
    ...
    <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
      <tr> 
        <!--Body Text-->
        <td valign="top" width="660"> <div align="center"> <FORM ENCTYPE="multipart/form-data" ACTION="edit_staff.php" METHOD=POST>
...
print ('<center>Select a Writer to Edit: </center><BR></td></tr><tr><td><select name="selected_staff">');
