...
<html>
<head>
<title>Valley Planet - Add New Issue</title>
      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="insert_issue.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  <tr> 
                    <td colspan="2"><div align="center"> 
                        <p class="title" style="text-align:center">Add New Issue</p>
                      </div></td>
                  </tr>
                  <tr> 
...
$max_issueid=$issueid+1;

					?>
                      <input name="new_issue" type="text" id="new_issue" size="3" value="<?php echo $max_issueid?>"> </td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    ...
                    <td width="320"><input name="year" type="text" id="month3" size="4" maxlength="4"></td>
                  </tr>
                  <tr> 
                    <td width="320"> <div align="right">Cover Pic:</div></td>
                  ...
                  <tr> 
					...
					if ($quad_counter=="4"){
					print ('<option value="'.$page_counter.'">'.$page_counter.'</option>');
