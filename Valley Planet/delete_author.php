...
<html>
<head>
<title>Valley Planet - Delete Author</title>
...
mysql_query("DELETE FROM $table WHERE authid = '$selected_author'") or die(mysql_error());
...
$firstimage = 'images/authors/'.$selected_author.'.jpg';
$secondimage = 'images/authors/thumbs/'.$selected_author.'.jpg';

ftp_delete ($conn_id, $firstimage);
ftp_delete ($conn_id, $secondimage);
				  
				  ?>
                      <p class="title" style="text-align:center">Author Deleted.</p>
                    </div></td>
                </tr>
                <tr> 
