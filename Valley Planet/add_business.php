...
<html>
<head>
<title>Valley Planet - Add New Business</title>
...
<div id="invis"> 
  ...
  <div id="content"> 
    ...
    <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
      <tr> 
        <!--Body Text-->
        <td valign="top" width="660"> <div align="center"> Add New Business 
          <FORM ENCTYPE="multipart/form-data" ACTION="insert_business.php" METHOD=POST>
...
?>
             ...
             <tr> 
              ...
              <tr> 
                ...
                <td><textarea name="description" cols="" rows=""></textarea>
                  <BR>
                  <BR></td>
              </tr>
            </table>
