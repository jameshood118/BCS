...
$file_name=$banner_id."_".$file_name;
}
...
mysql_query("UPDATE $table set Idnum='$banner_id',
...
Slot='$slot',
Page='$set_page'
WHERE Idnum = '$banner_id'") or die(mysql_error());
...
$destination_file='images/banners/'.$banner_id.'_'.$file_name;
