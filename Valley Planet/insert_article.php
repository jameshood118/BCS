...
mysql_query("INSERT into $table (catid, category, catorder) VALUES ('$category_id', '$new_category', '$category_order')") or die(mysql_error());
...
mysql_query("INSERT into $table (authid, first_name, last_name) VALUES ('$author_id', '$new_author_first', '$new_author_last')") or die(mysql_error());
...
mysql_query("INSERT into $table (id) VALUES ('$new_article')") or die(mysql_error());

mysql_query("UPDATE $table set id='$new_article',
catid='$category_id',
authid='$author_id',
date='$date',
headline='$headline',
...
issueid='$issueid',
pageno='$pageno'
WHERE id = '$new_article'") or die(mysql_error());
