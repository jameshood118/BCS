      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="insert_article.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  <tr> 
                    <td colspan="2"><div align="center"> 
                        <p class="title" style="text-align:center">Add New Article</p>
                      </div></td>
                  </tr>
                  <tr> 
...
$new_article=$id+1;
					...
					?>
                        Adding Article #: <?php echo $new_article?></div></td>
                    <td width="320"> <input name="new_article" type="hidden" id="new_article" value="<?php echo $new_article?>"> 
                    </td>
                  </tr>
                  <tr> 
                    <td> <div align="right">Month of Article (MM):</div></td>
                    <td><input name="month" type="text" id="month" size="2" maxlength="2"></td>
                  </tr>
                  <tr> 
                    <td> <div align="right">Day of Article (DD):</div></td>
                    <td><input name="day" type="text" id="day" size="2" maxlength="2"></td>
                  </tr>
                  <tr> 
                    <td width="320"> <div align="right">Year of Article (YY):</div></td>
                    <td width="320"><input name="year" type="text" id="year" size="4" maxlength="4"></td>
                  </tr>
                  <tr> 
                    <td><div align="right">Select Cateogy:</div></td>
...
print ('<option value="'.$c_catid.'">'.$c_category.'</option>');
                  ...
                  <tr> 
                    <td><div align="right">Selelct Author:</div></td>
...
print ('<option value="'.$a_authid.'">'.$a_name.'</option>');
                  ...
                  <tr> 
                    <td colspan="2"><div align="center"> 
                        <textarea name="story" cols="60" rows="30" id="story"></textarea>
                      </div></td>
                  </tr>
                  <tr> 
                    <td><div align="right">Issue #:</div></td>
                    <td><input name="issueid" type="text" id="issueid" size="3" maxlength="3"></td>
                  </tr>
                  <tr> 
                    <td><div align="right">Page #:</div></td>
                    <td><input name="pageno" type="text" id="pageno" size="3" maxlength="3"></td>
                  </tr>
                  <tr> 
                    <td>&nbsp;</td>
