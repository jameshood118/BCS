  ...
  <div id="content"> 
    ...
    <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
      <tr> 
        ...
        <div align="center"> 
          <FORM ENCTYPE="multipart/form-data" ACTION="insert_category.php" METHOD=POST><table width="650" border="0" cellspacing="5" cellpadding="0">
            <tr> 
            ...
            <tr> 
              <td width="320"></td></tr>
            <tr> 
              <td><div align="right">Add Category:</div></td>
              <td><input name="category" type="text"></td>
            </tr>
            <tr> 
              <td><div align="right">Add Category Description:</div></td>
