          ...
          <td valign="top" width="660"> <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="edit_category.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr> 
                    <td width="320"> <div align="right">Article Category To Edit:</div></td>
                    <td width="320"><select name="selected_category">
                        <?php 
...
print ('<input type="hidden" name="password" value="'.$password.'">');
					  ?>
                        <input type="submit" name="Submit" value="Edit Selected Category">
                      </div></td>
                  </tr>
                </table>
              </form>
