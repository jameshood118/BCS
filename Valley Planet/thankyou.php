  ...
  <div id="content"> 
    ...
    <div class="body"> 
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          <!--Body Text-->
          <td valign="top" width="660"> <table width="660" cellpadding=4>
              <tr valign="top"> 
                <td width="330" valign="top"> <p class="title"></p>
                  <p class="title" style="text-align:center;" align="center">Thanks for contacting Us!<BR></p>
                  <p class="text-indent">
                    <!-- Paragraph 1 -->
