...
$destination_file="images/store/".$Idnum.".jpg";
$source_file=$_FILES['file']['tmp_name'];
print("<br>Source File: ".$source_file."<br>");
print("Destination File: ".$destination_file."<BR><BR><BR>");
...
$destination_file2="images/store/".$Idnum."b.jpg";
$source_file2=$_FILES['fileb']['tmp_name'];
print("<br>Source File2: ".$source_file2."<br>");
print("Destination File2: ".$destination_file2."<BR><BR><BR>");
///check to see if file size is >0 and upload file if so.
