...
mysql_query("INSERT into $table (Idnum, Name, Bio) 
Values ('$new_Idnum_num', '$name', '$bio')") or die(mysql_error());
...
$filename="images/staff/".$new_Idnum_num.".jpg";
$destination="images/staff/thumbs/".$new_Idnum_num.".jpg";
