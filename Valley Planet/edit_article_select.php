...
<html>
<head>
<title>Valley Planet - Edit Article</title>
          ...
          <td valign="top" width="660"> <div align="center"> 
              <FORM ENCTYPE="multipart/form-data" ACTION="edit_article.php" METHOD=POST>
                <table width="650" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr> 
                    <td width="320"> <div align="right">Article:</div></td>
                    <td width="320"><select name="selected_article">
                        <?php 
...
$displayname='Date: '.$date.' - '.$headline.')';
$displayname=substr($displayname, 0, 90);

print ('<option value="'.$id.'">'.$displayname.'</option>');
...
print ('<input type="hidden" name="password" value="'.$password.'">');
					  ?>
                        <input type="submit" name="Submit" value="Edit Selected Article">
                      </div></td>
                  </tr>
                </table>
              </form>
