      ...
      <table border=0 cellpadding=4 cellspacing=0 style="margin-left:70px;">
        <tr> 
          ...
          <td valign="top" width="660"> <div align="center"> 
             ...
             <FORM ENCTYPE="multipart/form-data" ACTION="assign_event.php" METHOD=POST>
                  ...
                  <tr> 
                    <td width="320"> <div align="center">Event To Edit:</div></td></tr>
					<tr>
                    <td width="320"><div align="center"><select name="event2edit">
                        <?php
...
print ('<option value="'.$Idnum.'">'.$startdate.' - '.$listingname.' - '.$eventname.'</option>');
...
print ('<input type="hidden" name="password" value="'.$password.'">');
					  ?> 
                        <input type="submit" name="Assign" value="Assign Unassigned"></form>
                      </div></td>
                  </tr> 
            </div> </td></tr><</table>
