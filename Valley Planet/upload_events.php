              ...
              <table width="650" border="0" cellspacing="5" cellpadding="0">
                <tr> 
                  <td width="640"><div align="center"> 
                      <p class="title" style="text-align:center">Upload Events 
                        File </p>
                    </div></td>
                </tr>
                <tr>
                  <td><div align="center">Browse For CSV File Containing Events</div></td>
                </tr>
                <tr> 
                  <td> <div align="center"> 
                      <FORM ENCTYPE="multipart/form-data" ACTION="parse_csv.php" METHOD=POST>
                        <?php 
