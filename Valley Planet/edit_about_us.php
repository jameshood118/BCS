...
<html>
<head>
<title>Valley Planet - Edit About Us</title>
      ...
      <table style="margin-left:70px;" border=0 cellpadding=4 cellspacing=0>
        <tr> 
          ...
          <td valign="top" width="620" style="padding-right:20px;"> <p class="title">About 
              Us</p>
            <?php include('edit_about_include.php'); ?> <p style="float:right;padding-top:20px;"> <img src="images/about-map.jpg" alt="Background Image"/> 
            </p>
            <?php include('address_include.php'); ?> <?php include('contacts_include.php'); ?> <p class="title" style="margin-top:20px;">Valley Planet 
              Writers</p>
...
print ('<a href="images/staff/unknown.jpg"><img src="images/staff/thumbs/unknown.jpg" border="0"/></a>');
};
print ('</div>');
