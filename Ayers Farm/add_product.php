...
<title>Ayers Farm | Add Product</title>
...
$new_stock_number=$stock+1;
	...
	<form name="editproduct" id="editproduct" method="post" action="insert_product.php" enctype="multipart/form-data">
	  <p>Editing Item #:<?php echo $new_stock_number?> - 
...
$old_category=$list_category;
      ...
      <p>Availability<br>
        ...
        Dec<br>
        <br>
        <input type="hidden" value=<?php echo $new_stock_number?> name="stock">
