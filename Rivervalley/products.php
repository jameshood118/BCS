...
<div id="invis"> 
  ...
  <div id="title-text"> 
    ...
    <p class="sublinks"> <a href="javascript:showonlyone('newboxes1');">Our Current 
      Inventory</a> &bull; <a href="javascript:showonlyone('newboxes2');">View 
      Clearance Items</a> </p>
  </div>

    <div class="body"> 
      <div name="newboxes" id="newboxes1" style="display:block;"> 
        <?php include('products_page.php'); ?>
      </div>
