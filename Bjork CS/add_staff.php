...
<div id="invis"> 
  ...
  <div id="content" style="background:transparent url('images/content-bg-index.jpg') no-repeat top center;"> 
    ...
    Change Name: <input name="name" type="text"><BR>
    Change Job Title: <input name="title" type="text"><BR>
	Change Email: <input name="email" type="text"><BR>
	Change Quote: <input name="quote" type="text"><br>
    Change Bio:<textarea name="bio" cols="30" rows="5" wrap="VIRTUAL"></textarea><br>
...
print ('<input type="hidden" value="'.$loginpass.'" name="password">');
		  ?>
            <input type="submit" name="Submit" value="Submit Staff">
          </form>
