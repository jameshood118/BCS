...
<div id="invis"> 
  ...
  <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="360" height="240" id="commerial" align="middle">
            <param name="movie" value="video.swf" />
            <param name="quality" value="high" />
            <param name="wmode" value="transparent" />
            <param name="bgcolor" value="#ffffff" />
            <embed src="video.swf" quality="high" wmode="transparent" bgcolor="#ffffff" width="360" height="240" name="commercial"></embed> 
                </object>
        </div>
      </div>
      <div class="push"></div>
