...
$thumbnail="images/talkback/thumbs/".$Idnum.".jpg";
print("Destination File: ".$destination_file."<BR>");

// check upload status
if (ftp_delete($conn_id, $destination_file, $thumbnail)) {
...
mail( "jlbjork@gmail.com", "Your Talkback was Denied", $message, "From: $email" ); ?>
