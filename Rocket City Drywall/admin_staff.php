...
print ('<td width="300"><img src="images/staff/thumbs/'.$Idnum.'.jpg"></a><BR>');
print ('<HR>');
print ('<strong>Name: </strong>'.$name.'<BR>');
print ('<strong>Job Title: </strong>'.$title.'<BR>'); 
print ('<strong>Bio: </strong>'.$bio.'<BR>');
print ('<form name="form1" id="form1" method="post" action="delete_staff.php">');
...
print ('</form>');
print ('<form name="form2" id="form2" method="post" action="edit_staff.php">');
print ('<input type="hidden" value='.$login.' name="login">');
print ('<input type="hidden" value='.$loginpass.' name="password">');
print ('<input type="hidden" value='.$Idnum.' name="Idnum">');
